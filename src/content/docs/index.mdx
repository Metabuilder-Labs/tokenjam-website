...
A single-shot "how hard are you TokenMaxxing?" command that reads the last 30 days of usage, classifies it into a tier (TokenSipper → TokenGigaChad) based on the multiplier vs your declared plan, and surfaces the Downsize savings figure inline. Designed as a shareable screenshot artifact.
