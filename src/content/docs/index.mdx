---
title: Introduction
description: TokenJam is the cost-optimization layer for AI agents. Five analyzers (Downsize, Cache, Script, Trim, Reuse) read your existing telemetry and surface where to cut spend, plus a full local-first observability stack underneath. Open-source, no signup, runs entirely on your machine.
...
→ Details: [Reuse product page](/products/reuse)
